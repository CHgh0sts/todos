...
export default function MaintenancePage() {
      ...
      try {
        ...
        if (response.ok) {
          ...
          setMaintenanceInfo({
            ...
            message: data.message || 'Le site est temporairement en maintenance. Veuillez réessayer plus tard.'
          })
          
          // Si la maintenance est désactivée, rediriger vers l'accueil
          if (!data.isEnabled) {
            console.log('🔧 [Maintenance Page] Maintenance désactivée, redirection vers l\'accueil')
  ...
  return (
    <div className="maintenance-page fixed inset-0 bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-blue-900 flex items-center justify-center overflow-hidden">
      <div className="max-w-4xl w-full text-center px-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 mb-8 max-w-lg mx-auto">
          ...
          <div className="space-y-3 text-sm text-gray-600 dark:text-gray-300">
            ...
            <div className="flex items-center">
              <div className="w-6 h-6 bg-purple-100 dark:bg-purple-900 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
